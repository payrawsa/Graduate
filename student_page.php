        ...
        <div class="col-sm-12 form-group">
          ...
          <form action="feedback_submit.php" method="post" onsubmit="return validateForm()" name="myForm">
            <div class="row">
              <div class="col-sm-12 formgroup">
                ...
                <p>
                  ...
                  <div class="chart-scale">
                    <button class="btn btn-scale btn-scale-desc-1" type='button' onclick="score_change(1)" value=1>1</button>
                    <button class="btn btn-scale btn-scale-desc-2"type='button' onclick="score_change(2)" value=2>2</button>
                    <button class="btn btn-scale btn-scale-desc-3"type='button' onclick="score_change(3)" value=3>3</button>
                    <button class="btn btn-scale btn-scale-desc-4"type='button' onclick="score_change(4)" value=4>4</button>
                    <button class="btn btn-scale btn-scale-desc-5"type='button' onclick="score_change(5)" value=5>5</button>
                    <button class="btn btn-scale btn-scale-desc-6"type='button' onclick="score_change(6)" value=6>6</button>
                    <button class="btn btn-scale btn-scale-desc-7"type='button' onclick="score_change(7)" value=7>7</button>
                    <button class="btn btn-scale btn-scale-desc-8"type='button' onclick="score_change(8)" value=8>8</button>
                    <button class="btn btn-scale btn-scale-desc-9"type='button' onclick="score_change(9)" value=9>9</button>
                    <button class="btn btn-scale btn-scale-desc-10"type='button' onclick="score_change(10)" value=10>10</button>
                  </div>
                  <br><div class="row">                             <div class="col-sm-12 form-group">
                    <label style="color:white">Your Score: </label>  <p id=score style="display:inline; color:white"> </p> </div> </div>
                    <hr>
                    <script>
                    function score_change(value) {
              ...
              <div class="col-sm-12 form-group">
                <br>
                <label style="color:white">Leave Contact Information?</label>
